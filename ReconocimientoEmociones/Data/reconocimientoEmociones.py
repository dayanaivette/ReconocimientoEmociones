...
def emotionImage(emotion):
    image = None  # Valor predeterminado
...
#if method == 'LBPH': emotion_recognizer = cv2.face.LBPHRecognizer_create()

emotion_recognizer.read('modelo'+method+'.xml')
# --------------------------------------------------------------------------------

dataPath = 'C:/Users/dayan/Desktop/ReconocimientoEmociones/Data'  # Cambia a la ruta donde hayas almacenado Data
...
image = None  # Inicializa 'image' antes del bucle
...
while True:
    ...
    for (x,y,w,h) in faces:
        ...
        # EigenFaces
        #ciclo for para imprimir y saber i esta leyendo las emociones 
        for (x, y, w, h) in faces:
